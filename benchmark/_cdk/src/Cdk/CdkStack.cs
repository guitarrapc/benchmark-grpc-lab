...
namespace Cdk
{
    public class CdkStack : Stack
    {
        internal CdkStack(Construct scope, string id, IStackProps props = null) : base(scope, id, props)
        {
            ...
            // C:\git\guitarrapc\benchmark-lab\benchmark\out
            // C:\git\guitarrapc\benchmark-lab\out\linux\server
...
".Replace("\r\n", "\n"));
            ...
            {
                Image = ContainerImage.FromAsset(Path.Combine(Directory.GetCurrentDirectory(), "../../"), new AssetImageProps
                {
